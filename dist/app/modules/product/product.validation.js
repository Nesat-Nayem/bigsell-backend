...
const createProductValidation = zod_1.z.object({
    body: zod_1.z.object({
        ...
        isDiscount: zod_1.z.boolean().optional(),
        isWeeklyBestSelling: zod_1.z.boolean().optional(),
        isWeeklyDiscount: zod_1.z.boolean().optional(),
...
const getProductsValidation = zod_1.z.object({
    query: zod_1.z.object({
        ...
        category: zod_1.z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid category ID').optional(),
        subcategory: zod_1.z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid subcategory ID').optional(),
        subSubcategory: zod_1.z.string().regex(/^[0-9a-fA-F]{24}$/, 'Invalid sub-subcategory ID').optional(),
        brand: zod_1.z.string().optional(),
        ...
        isDiscount: zod_1.z.string().regex(/^(true|false)$/, 'Invalid discount filter').optional(),
        isWeeklyBestSelling: zod_1.z.string().regex(/^(true|false)$/, 'Invalid weekly best selling filter').optional(),
        isWeeklyDiscount: zod_1.z.string().regex(/^(true|false)$/, 'Invalid weekly discount filter').optional(),
